...
// or Developer Mode). If that privilege is missing, the test is skipped rather
// than failed because the behavior under test is fundamentally about how
// revdiff handles symlinks that already exist in a repo, not about whether
// Windows can create them.
